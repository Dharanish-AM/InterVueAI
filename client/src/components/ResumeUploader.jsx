...
import { Upload, Button, Card, Form, Input, Tag, Space, Alert, Spin } from 'antd';
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="mb-8 text-center">
        ...
        <p className="text-gray-600">Upload your resume and we'll extract your information automatically</p>
      </div>
        ...
        >
          ...
          >
            ...
            <p className="ant-upload-text">
              {loading ? 'Parsing resume...' : 'Click or drag resume to this area to upload'}
            </p>
            <p className="ant-upload-hint">
              Support for PDF and DOCX files. Your resume will be parsed automatically.
            </p>
          </Dragger>
